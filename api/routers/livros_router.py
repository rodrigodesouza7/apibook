...
def listar_livros(
    ...
    return service.listar(user_id, offset, limit)
...
def obter_livro(
    ...
    return service.obter(livro_id, user_id)
...
def criar_livro(
    ...
    return service.criar(livro, user_id)
...
def atualizar_livro(
    ...
    return service.atualizar(livro_id, livro, user_id)
...
def atualizar_parcial(
    ...
    return service.atualizar_parcial(livro_id, livro, user_id)
...
def deletar_livro(
    ...
    return service.deletar(livro_id, user_id)